<?php $__env->startSection('content'); ?>
    ...
    <form name="mutate" method="post" action="index.php">
        ...
        <div class="tab-pane" id="templatesPane">
            <script>
                var tp = new WebFXTabPane(document.getElementById('templatesPane'), <?php echo e(get_by_key(EvolutionCMS()->config, 'remember_last_tab') ? 1 : 0); ?>);
            </script>
            ...
            <div class="tab-page" id="tabAssignedTVs">
                ...
                <div class="container container-body">
                    ...
                    <?php if(EvolutionCMS()->hasPermission('save_template') && $data->tvs->count() > 1 && $data->getKey()): ?>
                        <div class="form-group">
                        ...
                        <?php $__env->startComponent('manager::partials.panelCollapse', ['name' => 'tv_in_template', 'id' => 0, 'title' => ManagerTheme::getLexicon('no_category')]); ?>
                            <ul>
                                <?php $__currentLoopData = $tvOutCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php echo $__env->make('manager::page.template.tv', compact('item', 'tvSelected'), array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
...
<?php echo $__env->make('manager::template.page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/manager//views//page/template.blade.php ENDPATH**/ ?>